...
import com.libro.domain.Cliente;
import com.libro.service.ClienteService;
...
/**
 * REST controller for managing {@link com.libro.domain.Cliente}.
 */
@RestController
@RequestMapping("/api")
public class ClienteResource {
    ...
    private static final String ENTITY_NAME = "librosCliente";
